from mars_profiling.report.presentation.flavours.html.frequency_table import (
    HTMLFrequencyTable,
)
from mars_profiling.report.presentation.flavours.html.html import HTMLHTML
from mars_profiling.report.presentation.flavours.html.image import HTMLImage
...
def test_html_html():
    test_str = "<strong>Blaat!</strong>"

    item = HTMLHTML(content=test_str)
    assert str(item) == "HTMLHTML"
    html = item.render()
