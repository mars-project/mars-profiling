...
from mars_profiling.model.describe import describe as describe_df
from mars_profiling.model.messages import MessageType
from mars_profiling.report import get_report_structure
from mars_profiling.report.presentation.flavours.html.templates import (
    create_html_assets,
)
from mars_profiling.serialize_report import SerializeReport
from mars_profiling.utils.dataframe import hash_dataframe, rename_index
from mars_profiling.utils.paths import get_config
...
class ProfileReport(SerializeReport):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if config_file:
            ...
            #     "default configuration, please run 'mars_profiling.clear_config()'"
            # )
        if explorative:
    ...
    def _render_html(self):
        from mars_profiling.report.presentation.flavours import HTMLReport
    ...
    def _render_widgets(self):
        from mars_profiling.report.presentation.flavours import WidgetReport
    ...
    def to_notebook_iframe(self):
        ...
        from mars_profiling.report.presentation.flavours.widget.notebook import (
            get_notebook_iframe,
        )
